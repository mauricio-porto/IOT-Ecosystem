...
public class PrivacyItem {
     ...
     *
     * @param allow indicates if the activityMsgListener allow or deny the communication.
     */
    ...
    /**
     * Returns whether the activityMsgListener allow or deny incoming IQ stanzas or not.
     *
    ...
    /**
     * Sets whether the activityMsgListener allows or denies incoming IQ stanzas or not.
     *
     * @param filterIQ indicates if the activityMsgListener allows or denies incoming IQ stanzas.
     */
    ...
    /**
     * Returns whether the activityMsgListener allows or denies incoming messages or not.
     *
    ...
    /**
     * Sets wheather the activityMsgListener allows or denies incoming messages or not.
     *
     * @param filterMessage indicates if the activityMsgListener allows or denies incoming messages or not.
     */
    ...
    /**
     * Returns whether the activityMsgListener allows or denies incoming presence or not.
     *
    ...
    /**
     * Sets whether the activityMsgListener allows or denies incoming presence or not.
     *
     * @param filterPresence_in indicates if the activityMsgListener allows or denies filtering incoming presence.
     */
    ...
    /**
     * Sets whether the activityMsgListener allows or denies outgoing presence or not.
     *
     * @param filterPresence_out indicates if the activityMsgListener allows or denies filtering outgoing presence
     */
    ...
    /**
     * Returns the order where the activityMsgListener is processed. List items are processed in
     * ascending order.
     *
    ...
    /**
     * Sets the order where the activityMsgListener is processed.
     *
     * The order MUST be filled and its value MUST be a non-negative integer
     * that is unique among all items in the list.
     *
    ...
    /**
     * Returns whether the activityMsgListener allows or denies every kind of communication.
     *
     * When filterIQ, filterMessage, filterPresence_in and filterPresence_out are not set
     * the activityMsgListener will block all communications.
     *
	...
	/**
	 * Answer an xml representation of the activityMsgListener according to the RFC 3921.
	 *
	...
	public static class PrivacyRule {
          ...
          * Sets the action associated with the item, it can allow or deny the communication.
          *
          * @param type indicates if the activityMsgListener allows or denies the communication.
          */
         ...
         /**
          * Returns if the activityMsgListener represents a subscription rule.
          *
          * @return if the activityMsgListener represents a subscription rule.
          */
