...
public class Privacy extends IQ {
    ...
    /** 
     * Returns whether the activityMsgListener allows or declines the use of an active list.
     * 
    ...
    /** 
     * Sets whether the activityMsgListener allows or declines the use of an active list.
     * 
     * @param declineActiveList indicates if the activityMsgListener declines the use of an active list.
     */
    ...
    /** 
     * Returns whether the activityMsgListener allows or declines the use of a default list.
     * 
     * @return the decline status of the list.
     */
    ...
    /** 
     * Sets whether the activityMsgListener allows or declines the use of a default list.
     * 
     * @param declineDefaultList indicates if the activityMsgListener declines the use of a default list.
     */
