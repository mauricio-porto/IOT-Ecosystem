...
public interface MessageEventNotificationListener {
    ...
    /**
     * Called when a notification that the activityMsgListener of the message is composing a reply is 
     * received.
     *  
     * @param from the user that sent the notification.
     * @param packetID the id of the message that was sent.
    ...
    /**
     * Called when a notification that the activityMsgListener of the message is offline is received.
     *  
     * @param from the user that sent the notification.
     * @param packetID the id of the message that was sent.
     */
    ...
    /**
     * Called when a notification that the activityMsgListener of the message cancelled the reply 
     * is received.
     *  
     * @param from the user that sent the notification.
     * @param packetID the id of the message that was sent.
