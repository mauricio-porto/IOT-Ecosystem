 ...
 * was delivered or when the activityMsgListener of the message is composing a reply. 
 *
...
public interface MessageEventRequestListener {
    ...
    /**
     * Called when a request that the activityMsgListener of the message is composing a reply notification is 
     * received.
     *  
     * @param from the user that sent the notification.
     * @param packetID the id of the message that was sent.
    ...
    /**
     * Called when a request that the activityMsgListener of the message is offline is received.
     *  
     * @param from the user that sent the notification.
     * @param packetID the id of the message that was sent.
     * @param messageEventManager the messageEventManager that fired the listener.
