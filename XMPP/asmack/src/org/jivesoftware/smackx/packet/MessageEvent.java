...
public class MessageEvent implements PacketExtension {
    ...
    */
     ...
     * when the activityMsgListener is composing a reply.
     * When the message is a notification returns if the activityMsgListener of the message is composing a 
     * reply.
     * 
     * @return true if the sender is requesting to be notified when composing or when notifying
     * that the activityMsgListener of the message is composing a reply
     */
    ...
    /**
     * When the message is a request returns if the sender of the message requests to be notified
     * when the activityMsgListener of the message is offline.
     * When the message is a notification returns if the activityMsgListener of the message was offline.
     * 
     * @return true if the sender is requesting to be notified when offline or when notifying 
     * that the activityMsgListener of the message is offline
     */
    ...
    /**
     * When the message is a notification returns if the activityMsgListener of the message cancelled 
     * composing a reply.
     * 
     * @return true if the activityMsgListener of the message cancelled composing a reply
     */
     ...
     * when the activityMsgListener is composing a reply.
     * When the message is a notification sets if the activityMsgListener of the message is composing a 
     * reply.
     * 
     * @param composing sets if the sender is requesting to be notified when composing or when 
     * notifying that the activityMsgListener of the message is composing a reply
     */
     ...
     * When the message is a request sets if the sender of the message requests to be notified
     * when the activityMsgListener of the message is offline.
     * When the message is a notification sets if the activityMsgListener of the message was offline.
     * 
     * @param offline sets if the sender is requesting to be notified when offline or when 
     * notifying that the activityMsgListener of the message is offline
     */
    ...
    /**
     * When the message is a notification sets if the activityMsgListener of the message cancelled 
     * composing a reply.
     ...
     * 
     * @param cancelled sets if the activityMsgListener of the message cancelled composing a reply
     */
