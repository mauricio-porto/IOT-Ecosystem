...
public class MessageEventManager {
    ...
    /**
     * Sends the notification that the activityMsgListener of the message is composing a reply
     * 
     * @param to the recipient of the notification.
     * @param packetID the id of the message to send.
     */
    ...
    /**
     * Sends the notification that the activityMsgListener of the message has cancelled composing a reply.
     * 
     * @param to the recipient of the notification.
     * @param packetID the id of the message to send.
     */
