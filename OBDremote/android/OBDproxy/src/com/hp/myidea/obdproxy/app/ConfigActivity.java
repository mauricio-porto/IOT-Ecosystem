...
public class ConfigActivity extends PreferenceActivity implements
   ...
   * @return
   */
  public static ArrayList<ObdBaseCommand> getObdCommands(SharedPreferences prefs) {
    ArrayList<ObdBaseCommand> cmds = ObdConfig.getCommands();
    ArrayList<ObdBaseCommand> ucmds = new ArrayList<ObdBaseCommand>();
    for (int i = 0; i < cmds.size(); i++) {
      ObdBaseCommand cmd = cmds.get(i);
